...
# Load models for feature extraction and tokenization
...
class MedVQAModel(nn.Module):
    ...
    def forward(self, pixel_values, question_input_ids, answer_input_ids):
        ...
        # Process answer text with teacher forcing
        ...
        # Generate answer with causal mask
...
def train_epoch(model, dataloader, optimizer, device):
    ...
    total_acc_overall = 0.0
    count_overall = 0
    total_loss_open = 0.0
    total_acc_open = 0.0
    count_open = 0
    total_loss_closed = 0.0
    total_acc_closed = 0.0
    count_closed = 0
    bleu_sum = 0.0
    rouge_sum = 0.0
    gen_open_count = 0
    ...
    return (overall_loss_avg, overall_acc_avg,
            closed_loss_avg, closed_acc_avg,
            open_loss_avg, open_acc_avg,
            open_bleu_avg, open_rouge_avg)
